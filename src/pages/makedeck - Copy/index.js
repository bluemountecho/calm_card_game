...
function MakeDeckPage(props) {
  ...
  useEffect(() => {
    ...
    connect(async (account) => {
      var username = (await axios.get(baseURL + '/getPlayerName/' + account)).data
      var battleInfo = (await axios.get(baseURL + '/getBattleInfo/' + account)).data
      ...
      var res = (await axios.get(baseURL + '/getDefaultCards')).data
      var arr1 = []
      ...
      res = (await axios.get(baseURL + '/getCardsFromDeck/' + account)).data
  ...
  return (
    <>
      <div className={classes.cardList}>
        <CardListTitle title="Captain" haveTopSpace="false" />
        ...
        <CardListTitle title="Melee Monster" haveTopSpace="true" />
        <div className={classes['l-container']}>
          { props.monsterCards.map((card, index) => (<Card
            CardShowType="big"
            Type={card.Type}
        ...
        <CardListTitle title="Ranged Monster" haveTopSpace="true" />
        <div className={classes['l-container']}>
        ...
        <CardListTitle title="Magic Monster" haveTopSpace="true" />
        <div className={classes['l-container']}>
